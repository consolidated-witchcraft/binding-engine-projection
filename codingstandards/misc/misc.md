...
* All slugs must be unique, lowercase and contain only numbers, letters, hyphens and underscores
* All slugs must be 100 characters or fewer.
* All slugs must not contain consecutive hyphens or underscores.
* All slugs must not start or end with a hyphen or underscore.
